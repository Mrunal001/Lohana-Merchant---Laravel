...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get();
         $id = Auth::id();
         $count_status =  RegisteredBusiness::where([
            ['status', '1'],
            ['user_id', $id]
        ])->count();
        
         return view('view_registered_busines', compact('list_reg_business','count_status'));
    }
    ...
    {
    	 return view('view_registered_busines');
    }
    ...
    return view('categories', compact('business_cat','list_reg_business','count_status')); 
    }
